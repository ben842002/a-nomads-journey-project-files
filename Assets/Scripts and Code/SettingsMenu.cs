...
public class SettingsMenu : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        LoadSliderAndVolumeData(); // UNCOMMENT AUDIO MIXER BELOW
        LoadQualityData();
    }
    ...
    {
        // first dropdown option is 0 (similar to index)
        qualityDropdown.value = PlayerPrefs.GetInt("Quality", 1);   // note: default quality is medium which is 1 index
    }
    ...
    public void SetQuality(int qualityIndex)
    {
        ...
        // save quality for changing scenes
