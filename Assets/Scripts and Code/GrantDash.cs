...
public class GrantDash : MonoBehaviour
{
    ...
    void CheckIfPlayerPickedUp()
    {
        ...
        bool hasAbility = PlayerStats.instance.dashAbility;
        if (hasAbility == true)
        {
    ...
    void Update()
    {
        ...
        {
            PlayerStats.instance.dashAbility = true;
            GetComponent<DialogueTrigger>().TriggerDialogue(); // tell instructions on how to use
